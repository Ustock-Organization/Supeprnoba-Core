...
export KINESIS_CHECKPOINT_ENABLED="true"
export KINESIS_CHECKPOINT_INTERVAL_RECORDS="100"
export KINESIS_CHECKPOINT_INTERVAL_SECONDS="5"

# Graceful Shutdown 설정
export SHUTDOWN_DRAIN_TIMEOUT_SECONDS="30"

# Shard 관리 설정 (Iterator 만료 방지)
export KINESIS_ITERATOR_REFRESH_SECONDS="240"
...
echo "  - CHECKPOINT: $KINESIS_CHECKPOINT_ENABLED (${KINESIS_CHECKPOINT_INTERVAL_RECORDS}rec/${KINESIS_CHECKPOINT_INTERVAL_SECONDS}s)"
echo "  - DRAIN_TIMEOUT: ${SHUTDOWN_DRAIN_TIMEOUT_SECONDS}s"
